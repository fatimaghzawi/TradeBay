    ...
    <header
      className={
        isPlatform
          ...
          : "sticky top-0 z-30 flex h-[var(--tb-topbar-height)] items-center gap-3 border-b border-[var(--tb-border)] bg-[color-mix(in_srgb,var(--tb-surface)_88%,transparent)] px-3 backdrop-blur-md sm:px-6"
      }
    >
      <button
        type="button"
        ...
        className="flex h-10 w-10 items-center justify-center rounded-xl border border-[var(--tb-border)] bg-[var(--tb-surface-muted)] text-[var(--tb-ink)] lg:hidden"
      >
