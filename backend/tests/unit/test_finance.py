"""Unit tests for Customer Finance — Decimal math, transitions, credit vs refund."""
...
def test_ledger_outstanding_from_events() -> None:
    # Invoice 2000 − payment 500 − credit 300 = 1200
...
def test_payment_pending_does_not_reduce_in_position_math() -> None:
    # Pending is excluded upstream; position only sees completed paid amount.
