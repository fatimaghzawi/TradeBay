...
class MembershipRepository(BaseRepository):
    ...
    async def get_active_membership(
        self, user_id: str | ObjectId, business_account_id: str | ObjectId
    ) -> dict[str, Any] | None:
...
class RolePermissionRepository(BaseRepository):
    ...
    async def list_permission_ids_for_role(self, role_id: str | ObjectId) -> list[ObjectId]:
...
class SessionRepository(BaseRepository):
    ...
    async def revoke(self, session_id: str | ObjectId, revoked_at: Any) -> dict[str, Any] | None:
        return await self.update(session_id, {"revoked_at": revoked_at})
