"""Catalog & inventory domain exceptions."""
...
class InsufficientStockError(ConflictError):
    def __init__(self) -> None:
        super().__init__("Insufficient available stock for this reservation")


class InsufficientReservedError(ConflictError):
    def __init__(self) -> None:
        super().__init__("Insufficient reserved stock for this operation")
